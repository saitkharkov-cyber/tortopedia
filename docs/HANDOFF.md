...
### Приоритет 2 — мелкая правка статьи 1042

Для UA-версии статьи «Як зберігати торт з мастикою» изменить H2 на:

```text
Як правильно вийняти торт із холодильника
```

Это согласованный вариант формулировки; не забыть внести правку в source, затем обычный build/publish/diff cycle.

### Приоритет 3 — мелкая правка статьи о сушке
